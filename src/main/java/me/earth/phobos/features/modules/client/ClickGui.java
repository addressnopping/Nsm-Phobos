...
public class ClickGui
    ...
    public Setting<Boolean> rainbow = this.register(new Setting<Boolean>("Rainbow(NsmCA)", false));
    public Setting<rainbowModeArray> rainbowModeA = this.register(new Setting<Object>("ARainbowMode(NsmCA)", rainbowModeArray.Static, v -> this.rainbow.getValue()));
    public Setting<rainbowMode> rainbowModeHud = this.register(new Setting<Object>("HRainbowMode(NsmCA)", rainbowMode.Static, v -> this.rainbow.getValue()));
    ...
    public Setting<Integer> red = this.register(new Setting<Integer>("Red", 6, 0, 255));
    public Setting<Integer> green = this.register(new Setting<Integer>("Green", 170, 0, 255));
    public Setting<Integer> blue = this.register(new Setting<Integer>("Blue", 255, 0, 255));
    public Setting<Integer> hoverAlpha = this.register(new Setting<Integer>("Alpha", 238, 0, 255));
    public Setting<Integer> alpha = this.register(new Setting<Integer>("HoverAlpha", 238, 0, 255));
