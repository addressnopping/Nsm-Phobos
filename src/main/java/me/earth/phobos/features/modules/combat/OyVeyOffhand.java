...
public class OyVeyOffhand
        extends Module {
    private static OyVeyOffhand instance;
    ...
    public OyVeyOffhand() {
        super("OyVeyOffhand", "OyVey's offhand module", Module.Category.COMBAT, true, false, false);
        instance = this;
    }

    public static OyVeyOffhand getInstance() {
        if (instance == null) {
            instance = new OyVeyOffhand();
        }
        return instance;
    }
