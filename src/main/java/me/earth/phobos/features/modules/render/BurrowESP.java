...
class BurrowESP
    ...
    public
    BurrowESP ( ) {
        super ( "BurrowESP" , "adding cuz why not" , Module.Category.RENDER , true , false , false );
    ...
    void lambda$onRender3D$8 ( Map.Entry entry ) {
        ...
        if ( this.name.getValue ( ) ) {
            RenderUtil.drawText2 ( new AxisAlignedBB ( (BlockPos) entry.getValue ( ) ) , ( (EntityPlayer) entry.getKey ( ) ).getGameProfile ( ).getName ( ) );
        }
    }
