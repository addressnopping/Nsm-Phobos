...
public class ModuleManager
    ...
    public void init() {
        ...
        this.moduleColorMap.put(this.getModuleByClass(Burrow.class), new Color(204, 191, 153));
        ...
        this.moduleColorMap.put(this.getModuleByClass(Anchor.class), new Color(206, 255, 255));
