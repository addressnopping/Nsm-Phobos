...
import me.earth.phobos.util.IMinecraft;

public class EntityUtil2 implements IMinecraft
{
    ...
    public static boolean isntValid(final Entity entity) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtil2.mc.player) || (entity instanceof EntityPlayer && Phobos.friendManager.isFriend(entity.getName()));
    }
    ...
    public static boolean isMoving() {
        return EntityUtil2.mc.player.motionX > Double.longBitsToDouble(Double.doubleToLongBits(1.9208899197057635E307) ^ 0x7FBB5AB8AD5DB287L) || EntityUtil2.mc.player.motionX < Double.longBitsToDouble(Double.doubleToLongBits(-4.710141003534489E307) ^ 0x7FD0C4C6CF24C3EFL) || EntityUtil2.mc.player.motionZ > Double.longBitsToDouble(Double.doubleToLongBits(1.3182290674040571E308) ^ 0x7FE7771B096D7F3FL) || EntityUtil2.mc.player.motionZ < Double.longBitsToDouble(Double.doubleToLongBits(-7.645656144229753E307) ^ 0x7FDB382D2E04048FL);
    }
}